...
const Hero = () => {
  ...
  return (
    ...
    <section id="hero" className="h-screen flex items-center justify-center relative overflow-hidden pt-24">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-16">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-base md:text-lg lg:text-xl text-gray-400 mb-8 max-w-3xl leading-relaxed">
              Desenvolvedor Front-end apaixonado por criar interfaces modernas.<br className="hidden md:block" />
          ...
          <div className="flex-1 flex justify-center md:justify-end mb-8 md:mb-0">
            <div className="relative">
              ...
              <div className="w-72 h-72 md:w-96 md:h-96 lg:w-[32rem] lg:h-[32rem] rounded-full bg-dark-primary flex items-center justify-center relative overflow-hidden border-4 shadow-xl" style={{ borderColor: '#D1D5DB' }}>
                <img
                  src={Imagelogo}
                  alt="Avatar"
