...
const Skills = () => {
  ...
  const skillCategories = [
    {
      ...
      skills: [
        { name: 'HTML5', level: 95, icon: '🌐', years: '4+ anos' },
        { name: 'CSS3 / Sass', level: 90, icon: '🎨', years: '4+ anos' },
        { name: 'JavaScript', level: 88, icon: '⚡', years: '3+ anos' },
        { name: 'TypeScript', level: 82, icon: '📘', years: '2+ anos' },
        { name: 'React.js', level: 85, icon: '⚛️', years: '2+ anos' },
        { name: 'Tailwind CSS', level: 92, icon: '💨', years: '2+ anos' }
      ]
    },
    {
      title: 'Back-end',
      ...
      skills: [
        { name: 'Node.js', level: 70, icon: '🟢', years: '1+ ano' },
        { name: 'Express.js', level: 65, icon: '🚀', years: '1+ ano' },
        { name: 'PostgreSQL', level: 60, icon: '🐘', years: '8 meses' },
        { name: 'MongoDB', level: 58, icon: '🍃', years: '6 meses' },
        { name: 'REST APIs', level: 75, icon: '🔗', years: '1+ ano' },
        { name: 'JWT Auth', level: 68, icon: '🔐', years: '8 meses' }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: 'Figma', level: 85, icon: '🎯', years: '2+ anos' },
        { name: 'VS Code', level: 95, icon: '💻', years: '4+ anos' },
        { name: 'Firebase', level: 78, icon: '🔥', years: '1+ ano' },
        { name: 'Vercel', level: 88, icon: '▲', years: '2+ anos' },
        { name: 'Postman', level: 80, icon: '📮', years: '1+ ano' }
      ]
    }
  ];
  ...
  return (
    <section id="skills" className="section-padding bg-dark-secondary/30 relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="container-custom mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center space-x-2 mb-4 glass px-4 py-2 rounded-full border border-neon-blue/30">
            ...
            <span className="text-neon-blue font-medium">Expertise Técnica</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            Minhas habilidades técnicas desenvolvidas ao longo da jornada como desenvolvedor
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-10 mb-20">
          {skillCategories.map((category, categoryIndex) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br from-${category.color}/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              
              {/* Category Header */}
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center space-x-4">
                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r from-${category.color} to-neon-purple flex items-center justify-center group-hover:scale-110 transition-transform duration-500 shadow-lg`}>
                      ...
                      <div key={skillIndex} className="space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <div className="flex items-center space-x-2 mt-1">
                                <rating.icon size={14} className={`text-${category.color}`} />
                          ...
                          <div className="text-right">
                            <span className={`text-lg font-bold text-${category.color} block`}>
                              {skill.level}%
                            </span>
                          </div>
                        </div>
        ...
        <div className="glass p-10 rounded-3xl border border-neon-purple/30 bg-gradient-to-r from-neon-purple/5 to-neon-blue/5 relative overflow-hidden">
          ...
          <div className="text-center relative z-10">
            <div className="flex items-center justify-center space-x-3 mb-6">
              <Zap className="text-neon-purple animate-bounce-subtle" size={28} />
              <h3 className="text-3xl font-bold text-neon-purple">Atualmente Aprendendo</h3>
              <Zap className="text-neon-purple animate-bounce-subtle" size={28} />
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-8">
              {[
                ...
                { name: 'GraphQL', icon: '🔗', color: 'neon-blue' },
                ...
                >
                  ...
                  <span className={`text-gray-300 font-semibold group-hover:text-${tech.color} transition-colors duration-300`}>{tech.name}</span>
                </div>
              ))}
            </div>
            
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Sempre em busca de novas tecnologias e tendências para oferecer as melhores soluções aos meus projetos.
              <br />
              <span className="text-neon-purple font-semibold">Em constante evolução tecnológica.</span>
            </p>
          </div>
        </div>
      </div>
